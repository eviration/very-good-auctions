...
IF NOT EXISTS (SELECT 1 FROM applied_migrations WHERE migration_name = '015_uat_system.sql')
BEGIN
    PRINT 'Applying migration: 015_uat_system.sql'
    ...
    -- Record migration
    INSERT INTO applied_migrations (migration_name) VALUES ('015_uat_system.sql');
    PRINT 'Migration 015_uat_system.sql applied successfully'
END
ELSE
BEGIN
    PRINT 'Migration 015_uat_system.sql already applied, skipping'
END
GO
