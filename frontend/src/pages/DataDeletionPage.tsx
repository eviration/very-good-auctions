    ...
    <div className="min-h-screen bg-clay-bg">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="clay-section">
          ...
          <p className="text-charcoal-light mb-8">Your data, your choice</p>

          <div className="prose prose-charcoal max-w-none space-y-8">
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Your Right to Delete Your Data</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">What Data Will Be Deleted</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Data We May Retain</h2>
              <p className="text-charcoal-light leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">How to Request Deletion</h2>
              <div className="clay-card p-6 bg-clay-mint/20">
                {isAuthenticated ? (
                  <div>
                    ...
                    <ol className="list-decimal list-inside text-charcoal-light space-y-2 ml-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Processing Time</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Before You Delete</h2>
              <p className="text-charcoal-light leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Facebook Login Users</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">Contact Us</h2>
              <p className="text-charcoal-light leading-relaxed">
