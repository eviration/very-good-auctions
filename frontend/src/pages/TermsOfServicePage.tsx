      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="clay-section">
          ...
          <div className="prose prose-charcoal max-w-none space-y-8">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">2. Description of Service</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">3. User Accounts</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">4. Bidding and Transactions</h2>
              <p className="text-charcoal-light leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">5. Organization Responsibilities</h2>
              <p className="text-charcoal-light leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">6. Prohibited Conduct</h2>
              <p className="text-charcoal-light leading-relaxed mb-4">
                You agree not to:
              </p>
              <ul className="list-disc list-inside text-charcoal-light space-y-2 ml-4">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">7. Fees and Payments</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">8. Intellectual Property</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">9. Limitation of Liability</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">10. Dispute Resolution</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">11. Termination</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">12. Changes to Terms</h2>
              <p className="text-charcoal-light leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-charcoal mb-3">13. Contact</h2>
              <p className="text-charcoal-light leading-relaxed">
